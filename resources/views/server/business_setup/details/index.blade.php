        ...
        <div class="content-header-left col-12 mb-2 mt-1">
            <div class="row breadcrumbs-top">
                <div class="col-12">
                    ...
                    @endif
                    <h5 class="content-header-title float-left pr-1 mb-0">Setup Details Table</h5>
                    <div class="breadcrumb-wrapper col-12">
                        <ol class="breadcrumb p-0 mb-0">
                            <li class="breadcrumb-item"><a href="{{ route('dashboard') }}"><i class="bx bx-home-alt"></i></a>
                            </li>
                            <li class="breadcrumb-item active">Setup Details
                            </li>
                        </ol>
                    </div>
                </div>
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h5 class="card-title">Setup Detail List</h5>
                                        ...
                                        <tbody>
                                            @if ($details)
                                                @foreach ($details as $detail)
                                                    <tr>
                                                        <td><img src="{{ asset('images/setup/'.$detail->image) }}" alt="" height="150px"></td>
                                                        <td class="text-bold-600" >@if ($detail->setup)
                                                            {{ $detail->setup->title }}
                                                        @endif</td>
                                                        ...
                                                        <td>
                                                            <div class="dropdown">
                                                                ...
                                                                <div class="dropdown-menu dropdown-menu-right">
                                                                    <a class="dropdown-item" href="{{ route('setup-detail.edit',$detail->id) }}"><i class="bx bx-edit-alt mr-1"></i> edit</a>
