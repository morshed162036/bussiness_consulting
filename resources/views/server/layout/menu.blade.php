    ...
    <div class="main-menu menu-fixed menu-light menu-accordion menu-shadow" data-scroll-to-active="true">
        ...
        <div class="main-menu-content">
            <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation"
                ...
                <li class=" nav-item"><a href="#"><i class="bx bxs-cog"></i><span class="menu-title">Business Setup Section</span></a>
                    <ul class='menu-content'>
                        <li><a href="{{ route('setup.index') }}"><i class="bx bx-right-arrow-alt"></i><span
                                    class="menu-item" data-i18n="LivIcons">Setup List</span></a>
                        </li>
                        <li><a href="{{ route('setup-detail.index') }}"><i class="bx bx-right-arrow-alt"></i><span
                                    class="menu-item" data-i18n="LivIcons">Setup Details</span></a>
                        </li>
                    </ul>
                </li>
                 <li class=" nav-item"><a href="{{ route('question.index') }}"><i class="bx bxs-categories"></i><span
                            class="menu-title">Question-Answer</span></a>
                </li>
                ...
                <li class=" navigation-header"><span>About Page</span></li>
                 <li class=" nav-item"><a href="{{ route('about-company.index') }}"><i class="bx bxs-customize"></i><span
                            class="menu-title">About Company</span></a>
                </li>
                  {{--  order page  --}}
                   <li class=" navigation-header"><span>Service/Setup page</span></li>
                    <li class=" nav-item"><a href="{{ route('order.index') }}"><i class="bx bx-cart-alt"></i><span                      class="menu-title">Appointment</span></a>
                    </li>
                    <li class=" nav-item"><a href="{{ route('ceo-message.index') }}"><i class="bx bx-cart-alt"></i><span
                            class="menu-title">CEO Message</span></a>
                    </li>
