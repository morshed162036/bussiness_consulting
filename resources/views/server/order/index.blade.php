                ...
                <div class="col-12">
                    ...
                    <div class="breadcrumb-wrapper col-12">
                        <ol class="breadcrumb p-0 mb-0">
                            ...
                            <li class="breadcrumb-item active">Appointment
                            </li>
                        </ol>
                    </div>
                </div>
                                            ...
                                            @if ($orders)
                                               @foreach($orders as $order)
                                                    <tr>
                                                        ...
                                                        <td>{{ $order->email }}</td>
                                                        <td>{{ $order->date }}</td>
                                                        <td class="text-bold-600 text-primary">@if ($order->service)
                                                            {{ $order->service->title}}
                                                        @endif</td>
                                                        <td class="text-bold-600 text-primary">@if ($order->setup)
                                                            {{ $order->setup->title}}
                                                        @endif</td>
