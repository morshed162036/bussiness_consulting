...
<div class="content-header row">
    <div class="content-header-left col-12 mb-2 mt-1">
        <div class="row breadcrumbs-top">
            <div class="col-12">
                <h5 class="content-header-title float-left pr-1 mb-0">Appointment edit</h5>
                <div class="breadcrumb-wrapper col-12">
                    <ol class="breadcrumb p-0 mb-0">
                        <li class="breadcrumb-item"><a href="{{ route('dashboard') }}"><i
                                    class="bx bx-home-alt"></i></a>
                        </li>
                        <li class="breadcrumb-item"><a href="{{ route('order.index') }}">Appointment List</a>
                        </li>
                        <li class="breadcrumb-item active">Appointment Edit
                        </li>
                    </ol>
                </div>
            </div>
                                        ...
                                        <div class="col-md-10">
                                            <fieldset class="mt-2">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <select name="setup_id" id="" class="form-control">
                                                        @foreach ($setups as $setup )
                                                        <option value="{{ $setup->id }}" @if(old('setup_id', $setup) == $setup->id) selected @endif>
                                                        {{ $setup->title }}</option>Select</option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                            </fieldset>
