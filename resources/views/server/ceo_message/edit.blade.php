...
<div class="content-header row">
    <div class="content-header-left col-12 mb-2 mt-1">
        <div class="row breadcrumbs-top">
            <div class="col-12">
                <h5 class="content-header-title float-left pr-1 mb-0">CEO Message Edit</h5>
                <div class="breadcrumb-wrapper col-12">
                    <ol class="breadcrumb p-0 mb-0">
                        <li class="breadcrumb-item"><a href="{{ route('dashboard') }}"><i class="bx bx-home-alt"></i></a>
                        </li>
                        <li class="breadcrumb-item"><a href="{{ route('ceo-message.index') }}">CEO Message</a>
                        </li>
                        <li class="breadcrumb-item active">CEO Message Edit
                        </li>
                    </ol>
                </div>
            </div>
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-content">
                        <form action="{{ route('ceo-message.update',$message->id) }}" method="post" enctype="multipart/form-data"> @csrf @method('put')
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-md-10">
                                        <fieldset>
                                        ...
                                        <img src="{{ asset('images/ceo/'.$message->image) }}" id="output" alt="imahe" width="200px" height="400px" class="mt-2 mx-1">
                                        @endif

                                    <div class="col-md-10">
                                        <fieldset>
                                            <h5>Sign <span class="star">*</span></h5>
                                            <div class="input-group">
                                                <div class="input-group-prepend">
                                                    <span class="input-group-text" id="basic-Createon1"><i class="bx bx-file"></i></span>
                                                </div>
                                                <input type="file" class="form-control" aria-describedby="basic-Createon1" name="sign" onchange="loadSign(event)">
                                            </div>
                                        </fieldset>

                                        @if($message->sign != null)
                                        <img src="{{ asset('images/ceo/'.$message->sign) }}" id="output-sign" alt="sign" width="400px" height="200px" class="mt-2 mx-1">
                                        @endif
                                        ...
                                        <fieldset class="mt-2">
                                            ...
                                            <div class="input-group">
                                               ...
                                               <input type="text" class="form-control" value="{{ $message->designation }}" name="designation">
                                            </div>
                                        </fieldset>
                                        <fieldset class="mt-2">
                                            ...
                                            <div class="input-group">
                                               ...
                                               <input type="text" class="form-control" value="{{ $message->title }}" name="title">
                                            </div>
                                        </fieldset>
                                        
                                        <fieldset class="mt-2">
                                            <h5>Peragraph 1 <span class="star">*</span></h5>
                                            <textarea name="pera_1" id="pera_1" required>{{ $message->pera_1 }}</textarea>
                                        </fieldset>
                                        <fieldset class="mt-2">
                                            <h5>Peragraph 2 <span class="star">*</span></h5>
                                            <textarea name="pera_2" id="pera_2">{{ $message->pera_2 }}</textarea>
                                        </fieldset>
...
@section('js')
    ...
    <script>
        ClassicEditor
            .create( document.querySelector( '#pera_1' ) )
            .catch( error => {
                console.error( error );
            } );
    </script>
    <script>
        ClassicEditor
            .create( document.querySelector( '#pera_2' ) )
            .catch( error => {
                console.error( error );
            } );
    </script>
    ...
    <script>
        var loadSign = function(event) {
            var output = document.getElementById('output-sign');
            output.src = URL.createObjectURL(event.target.files[0]);
            output.height =  '300';
        }
    </script>
